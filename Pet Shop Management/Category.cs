    ...
    public partial class Category : Form
    {
        ...
        private void Deletebtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmdPr = new SqlCommand("Delete from ProductTbl where CatID=@EKey", Con);
                    cmdPr.Parameters.AddWithValue("@EKey", Key);
                ...
                {
                    MessageBox.Show("This category is protected! There're items have this category");
                }
            }
        }
