    ...
    public partial class Products : Form
    {
        ...
        private void Savebtn_Click(object sender, EventArgs e)
        {
            ...
            else if (PriceTb.Text == "")
            {
                ...
                PriceTb.Focus();
            } else if (Convert.ToInt32(PriceTb.Text) <= 0)
            {
                MessageBox.Show("Price must be larger than 0!");
                PriceTb.Focus();
            } 
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            Con.Open();
                            string Query2 = "Select * from ProductTbl where PrName = '" + PrNameTb.Text + "' and CatId = '" + CatCb.SelectedValue + "'";
                            ...
                            {
                                Con.Open();
                                string Query3 = "Select * from ProductTbl where PrId = '" + Key + "' and PrName = '" + PrNameTb.Text + "' and CatId = '" + CatCb.SelectedValue + "'";
        ...
        private void Deletebtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmdB = new SqlCommand("Delete from BillTbl where PrId=@EKey", Con);
                    cmdB.Parameters.AddWithValue("@EKey", Key);
